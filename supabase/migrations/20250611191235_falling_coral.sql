/*
  # Create Construction Estimation App Schema
  ...
  1. New Tables
    - `projects`
      ...
      - `status` (text, project status with enum values)
      - `total_cost` (numeric, calculated total cost)
      - `accuracy` (numeric, estimation accuracy percentage)
  ...
  2. Security
    ...
    - Users can only access projects and related data they own
*/
